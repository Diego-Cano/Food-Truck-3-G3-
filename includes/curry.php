...
curry combines herbs, spices, and aromatic leaves for a tantalizing experience you won\'t soon forget!', 12.95, 0);
...
to deliver a truly unforgettable meal!', 13.95, 0);
// $myCurries->addExtra("white");
// $myCurries->addExtra("brown");
// $myCurries->addExtra("sticky");
// $myCurries->addExtra("basmati");
...
vegetables and thickend by a home-made roux', 10.95, 0);
// $myCurries->addExtra("white");
// $myCurries->addExtra("brown");
// $myCurries->addExtra("sticky");
// $myCurries->addExtra("basmati");
